...
export const mapHeroGamesData = (heroStat: any) => {
    console.log('mapHeroGamesData heroStat', heroStat);
    return {
        '1_pick': heroStat['1_pick'],
        '1_win': heroStat['1_win'],
        '2_pick': heroStat['2_pick'],
        '2_win': heroStat['2_win'],
        '3_pick': heroStat['3_pick'],
        '3_win': heroStat['3_win'],
        '4_pick': heroStat['4_pick'],
        '4_win': heroStat['4_win'],
        '5_pick': heroStat['5_pick'],
        '5_win': heroStat['5_win'],
        '6_pick': heroStat['6_pick'],
        '6_win': heroStat['6_win'],
        '7_pick': heroStat['7_pick'],
        '7_win': heroStat['7_win'],
        '8_pick': heroStat['8_pick'],
